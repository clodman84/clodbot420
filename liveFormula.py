...
TeamImage = {
    ...
    "Mercedes": [
        "https://www.formula1.com/content/dam/fom-website/teams/2021/mercedes.png.transform/4col/image.png",
        "https://www.formula1.com/content/dam/fom-website/teams/2021/mercedes-logo.png.transform/2col/image"
        ".png",
    ],
    "McLaren": [
        "https://www.formula1.com/content/dam/fom-website/teams/2021/mclaren.png.transform/4col/image.png",
    ...
    "Alpine": [
        "https://www.formula1.com/content/dam/fom-website/teams/2021/alpine.png.transform/4col/image.png",
    ...
    "Ferrari": [
        "https://www.formula1.com/content/dam/fom-website/teams/2021/ferrari.png.transform/4col/image.png",
    ...
    "Williams": [
        "https://www.formula1.com/content/dam/fom-website/teams/2021/williams.png.transform/4col/image.png",
...
async def plotPos(live, colours):
    ...
    for driver in data.keys():
        ...
        plt.gca().tick_params(
            axis="y", right=True, left=True, labelleft=False, labelright=True
        )
...
async def extracTimeData(path):
    res = []
    timeData = await get(
        f"https://livetiming.formula1.com/static/{path}TimingData.json"
    )
